...
import {Container, Header, Button,Content, Footer, FooterTab, Input, Item, Row, Text, Icon } from 'native-base';
                            ...
                            <View key={image.image}>
                                <Row>
                                    ...
                                    <View style={styles.titleall}>
                                        ...
                                        <Button small warning><Text> + Favorite </Text></Button>
                                    </View> 
                                </Row>
                            </View>
                        ))}
